...
nodes.adhiNode = require("./nodeHelpers/adhiNode");
...
nodes.adhiNodeObj = {
	...
	blockExplorerTX: "",
	blockExplorerAddr: "",
	type: nodes.nodeTypes.Adhi,
	eip155: true,
	chainId: 1,
	tokenList: [],
	abiList: [],
	service: "Adhi",
	lib: new nodes.customNode("http://localhost", "8545")
},
nodes.nodeList = {
	eth_mew: {
		name: "ETH",
	...
	adhi: {
		...
		abiList: [],
		service: "Adhi",
		lib: new nodes.adhiNode("http://localhost", "8545")
	}
};
