...
customNode.prototype.getTransaction = function(txHash, callback) {
    this.post({
        method: 'adh_getTransactionByHash',
        params: [txHash]
    }, function(data) {
        if (data.error) callback({ error: true, msg: data.error.message, data: '' });
...
customNode.prototype.getTransactionData = function(addr, callback) {
    ...
    var parentObj = this;
    var reqObj = [
        { "id": parentObj.getRandomID(), "jsonrpc": "2.0", "method": "adh_getBalance", "params": [addr, 'pending'] },
        { "id": parentObj.getRandomID(), "jsonrpc": "2.0", "method": "adh_gasPrice", "params": [] },
        { "id": parentObj.getRandomID(), "jsonrpc": "2.0", "method": "adh_getTransactionCount", "params": [addr, 'pending'] }
    ];
...
customNode.prototype.getEthCall = function(txobj, callback) {
    ...
    ethCallArr.calls.push({ "id": parentObj.getRandomID(), "jsonrpc": "2.0", "method": "adh_call", "params": [{ to: txobj.to, data: txobj.data }, 'latest'] });
